...
/**
 * Translate shape moves the shape by following the mouse
 */
public class TranslateCommand implements Commands {
    ...
    public TranslateCommand(Point2D curr, Point2D newCurr, Selectable selectedShape, double ogX,
                            double ogY) {
        this.curr = curr;
