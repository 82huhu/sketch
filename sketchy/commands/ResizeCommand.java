 ...
 */
public class ResizeCommand implements Commands {
    ...
    public ResizeCommand(double initialWidth, double initialHeight, Selectable selectedShape,
                         Point2D curr) {
    ...
    public void execute() {
        ...
        //rotates the points of the logical rectangle so resize works for rotated shapes
