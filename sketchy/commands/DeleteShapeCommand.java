...
/**
 * DeleteShapeCommand is a command which erases a shape off the screen
 */
public class DeleteShapeCommand implements Commands {
    private Selectable selectedShape;
    private ArrayList<Selectable> shapes;
    private ArrayList<Saveable> saveables;
    private Pane canvasPane;

    public DeleteShapeCommand(Selectable selectedShape, ArrayList<Selectable> shapes,
