...
/**
 * RaiseCommand is a command which moves a selected shape up a layer
 */
public class RaiseCommand implements Commands {
    ...
    public RaiseCommand(ArrayList<Selectable> shapes, ArrayList<Saveable> saveables, Selectable selectedShape, Pane canvasPane) {
        this.shapes = shapes;
