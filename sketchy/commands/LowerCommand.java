...
/**
 * LowerCommand is a command which moves a selected shape down a layer
 */
public class LowerCommand implements Commands {
    ...
    public LowerCommand(ArrayList<Selectable> shapes, ArrayList<Saveable> saveables, Selectable selectedShape, Pane canvasPane) {
        this.shapes = shapes;
