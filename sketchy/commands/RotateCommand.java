...
/**
 * RotateCommand rotates the shape based on the mouse
 */
public class RotateCommand implements Commands {
    ...
    public RotateCommand(Selectable selectedShape, double angle, Point2D curr, Point2D newCurr, double initialRotation) {
